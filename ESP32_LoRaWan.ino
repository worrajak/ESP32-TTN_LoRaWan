...
static unsigned char NWKSKEY[16] = { 0x00, 0x00, 0x9A, 0x06, 0xBA, 0x41, 0x5F, 0xDB, 0x2A, 0x53, 0xB5, 0x01, 0xEB, 0xEE, 0x44, 0x13 };
// LoRaWAN AppSKey, application session key, 16 bytes  (from staging.thethingsnetwork.org)
static unsigned char APPSKEY[16] = { 0x00, 0x00, 0xB2, 0x83, 0x40, 0xE0, 0x5D, 0xEF, 0xAD, 0x48, 0x40, 0x04, 0x4C, 0x17, 0x83, 0x22 };
...
void setup() {
  ...
  display.drawString(0, 0, "ESP32 TTN112 ");
  display.drawString(0, 1, "923.2MHz SF10");
